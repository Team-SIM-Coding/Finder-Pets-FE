...
const ReUnionReviewsDetailDescription = () => {
  return (
    <article className={cs.detailSectionStyle}>
      ...
      <Divider size={6} />
      <Spacing height="12px" />
      <DetailDescriptionTextBox text="마음이 아픕니다우리 집에 와서 있는 동안 하루  두 세번 꼭 산책시켜주고 밥 먹여주고 같이놀고 24시간 붙어있던 아이 입니다. 어제 갑자기 실신해서 병원에 데려갔는데.." />
      <Spacing height="12px" />
      <Divider size={6} />
      <Spacing height="12px" />
    </article>
